...
<p align="left">
  ...
  <img alt="Mod Loader" src="https://img.shields.io/badge/Mod-Godot%20Mod%20Loader-8a63d2" />
...
- 🧩 **可扩展性**：内置 Mod Loader 与扩展桥，支持注入敌人/升级/武器与事件
...
- 📦 玩家安装指南：[`docs/MOD_INSTALL_GUIDE.md`](docs/MOD_INSTALL_GUIDE.md)  
- 🛠 开发运行机制：[`docs/MOD_RUNTIME_OVERVIEW.md`](docs/MOD_RUNTIME_OVERVIEW.md)
...
├─ scenes/           # 场景
├─ scripts/          # 游戏逻辑脚本
├─ addons/           # 插件（含 mod_loader）
├─ assets/           # 资源素材
├─ docs/             # 文档（GDD、Mod 指南、截图等）
├─ mods-unpacked/    # 编辑器调试用解包 Mod
└─ project.godot
```
