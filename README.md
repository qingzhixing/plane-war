...
竖屏弹幕射击小品：**波次清场 → 三选一强化 → Boss**，以 **评分 / 连击 / DPS** 为核心反馈，采用 **2 条命离散生命值系统**（受击扣命，生命归零后下一次受击才结束本局）。  
...
- **惩罚**：玩家拥有固定 **2 条命**；受击在结算护盾后若仍命中则扣 1 命并短暂无敌，生命未归零时可继续战斗但会 **断连击 / 衰减评分加成**，生命归零后下一次受击才结束本局；整体鼓励多打刷高分  
