...
@onready var _fallback_bullet_scene_basic: PackedScene = preload("res://scenes/bullets/PlayerSpellBullet.tscn")
@onready var _fallback_bullet_scene_arrow: PackedScene = preload("res://scenes/bullets/PlayerSpellBullet.tscn")
@onready var _fallback_bullet_scene_boomerang: PackedScene = preload("res://scenes/bullets/PlayerSpellBullet.tscn")
@onready var _fallback_bullet_scene_bomb: PackedScene = preload("res://scenes/bullets/PlayerSpellBullet.tscn")
